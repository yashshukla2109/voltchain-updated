...
const Welcome = () => {
  ...
  if (!sessionLoaded)
    return <div className="text-white flex justify-center items-center h-screen">Checking session...</div>;
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        ...
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <div className="flex justify-center items-center">
            <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
              Send Crypto Using VoltChain
            </h1>
          </div>
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-2xl">
            Welcome, {user.email}! Explore the crypto world. Buy and sell electricity easily on VoltChain.
          </p>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-80 sm:w-72 w-full my-5 eth-card white-glassmorphism">
